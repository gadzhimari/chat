            ...
            <Link to="/signup">
              <Button
                ...
                onClick={::this.handleSubmit}>
                  <p style={{margin: '0', padding: '0', fontSize: '1.1em'}}>Зарегистироваться</p>
              </Button>
            </Link>
            </form>
            <p style={{margin: '1em', textAlign: 'center'}}>Или</p>
            <Link to="/signin">
              <Button style={{width: '100%'}} bsStyle="default" >Войти</Button>
            </Link>
          </main>
        </div>
      );
    ...
    return (
      <div>
        <header style={{display: 'flex', justifyContent: 'center', flexGrow: '0', order: '0'}}>
          <div style={{justifyContent: 'center'}}><p style={{fontSize: '1.5em', marginRight: '1em'}}>Добро пожаловать в чат</p>
          </div>
        </header>
        <main style={{display: 'flex', justifyContent: 'center'}}>
          ...
          <div style={{height: '3.5em', width: '12em', alignSelf: 'center', display: 'flex', marginLeft: '1em'}}>
            <p style={{marginRight: '1em', marginTop: '1em'}}> Или </p>
            <Link to="/signin">
              <Button style={{margin: 'auto', height: '3.5em'}} bsStyle="default" >Войти</Button>
            </Link>
          </div>
        </main>
      </div>
